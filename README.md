# TP-LAB-2015
Repository for 2015 Lab Microbiology Chulalongkorn
...
Just a reminder for me (JK) of how to use GitHub
  ```sh
  git add .
  git commit -m "[ WRITE SOMETHING HERE ]"
  git remote add origin https://github.com/jeerameth/TP-LAB-2015
